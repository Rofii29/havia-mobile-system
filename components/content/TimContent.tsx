...
export const TimContent: React.FC<TimContentProps> = ({ onNav }) => (
  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300 pb-32">
    ...
    <div className="grid grid-cols-3 gap-3">
      {/* Tombol Absensi */}
      <button onClick={() => onNav('subpage', null, 'Absensi')} className="flex flex-col items-center justify-center bg-[#2C2A29] border border-neutral-800 rounded-3xl p-5 hover:border-[#C69C3D]/50 transition-colors group relative overflow-hidden active:scale-95 duration-200 shadow-lg">
